                ...
                <div class="flex-1 flex relative">
                    ...
                    <div x-data="{
                        ...
                        scrollTo(messageId) {
                         ...
                         class="chat-area flex-grow h-full w-full flex flex-col justify-between">
                        <div class="px-4 h-10 flex items-center justify-end lg:justify-center">
                            <h3 class="text-lg border-b border-orange-500 text-white inline-flex items-center">
                                ...
                                @endif
                                {{ isset($room) ? $room->name : $this->otherUser->login }}
                            </h3>
                        </div>
                        ...
                        <form class="py-4 px-4">
                            ...
                            <div x-transition :class="replyTo.id ? 'rounded-b-lg' : 'rounded-lg'"
                                ...
                                <textarea x-ref="chat" rows="1" x-on:input="resize()" x-on:keydown="send($event)"
                                          x-model="content"
