            ...
            <x-slot name="content">
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-x-6 sm:gap-y-2">
                    ...
                    @if ($this->form->room)
                        ...
                        <div>
                            <label for="members"
                                class="text-gray-600">Members</label>
                            <div
                                ...
                                @forelse ($form->members as $member)
                                    <span
                                        class="border-orange-400 bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-300 inline-flex items-center rounded-lg border px-2 py-1 font-medium">
                                        {{ $member->login }}
