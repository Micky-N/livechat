            ...
            <div class="main flex-1 flex flex-col">
                <div class="flex-1 flex relative">
                    ...
                    <div x-data="{
                        ...
                        <div class="h-full grid grid-rows-1 justify-items-stretch overflow-auto relative">
                            <div x-ref="messages" id="messages" class="overflow-auto absolute flex-1 grid grid-rows-1 gap-y-4 w-full">
